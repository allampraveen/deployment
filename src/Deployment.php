...
use smsg\deployment\utilities\Deployment as DeploymentUtility;
use smsg\deployment\widgets\Deployment as DeploymentWidget;
    ...
    public function init()
    {
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = DeploymentUtility::class;
            }
        );
        ...
        Event::on(
            ...
            function (RegisterComponentTypesEvent $event) {
                $event->types[] = DeploymentWidget::class;
            }
        );
