...
namespace smsg\deployment\widgets;

use smsg\deployment\Deployment;
use smsg\deployment\assetbundles\deploymentwidget\DeploymentWidgetAsset;
 ...
 * @since     1.0.0
 */
class Deployment extends Widget
{
    ...
    {
        return Craft::getAlias("@smsg/deployment/assetbundles/deploymentwidget/dist/img/Deployment-icon.svg");
    }
    ...
    public function getSettingsHtml()
    {
        return Craft::$app->getView()->renderTemplate(
            'deployment/_components/widgets/Deployment_settings',
            [
                'widget' => $this
            ]
        );
    ...
    {
        Craft::$app->getView()->registerAssetBundle(DeploymentWidgetAsset::class);

        return Craft::$app->getView()->renderTemplate(
            'deployment/_components/widgets/Deployment_body',
            [
